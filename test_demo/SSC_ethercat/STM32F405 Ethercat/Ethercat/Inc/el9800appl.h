...
typedef struct OBJ_STRUCT_PACKED_START {
   ...
   REAL32 REAL_input; /**< \brief (SI17) Analog input value*/
} OBJ_STRUCT_PACKED_END
TOBJ6020;
...
#ifdef _EVALBOARD_
= {8, {0x60200101, 0x60200201, 0x60200302, 0x60200502, 0x08, 0x18020701, 0x18020901, 0x60201120}}
#endif
;
/** @}*/
 ...
 */
OBJCONST UCHAR OBJMEM aName0x6020[] = "AI Inputs\000Underrange\000Overrange\000Limit 1\000\000Limit 2\000\000\000\000\000\000\000\000\000\000TxPDO State\000TxPDO Toggle\000REAL_input\000\377";
#endif //#ifdef _OBJD_
